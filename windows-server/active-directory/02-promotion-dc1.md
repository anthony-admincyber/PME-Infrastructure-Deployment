...
La promotion permet de créer la première forêt Active Directory de l'environnement et d'établir le domaine :
...
Le domaine Active Directory qui sera créé est :
